...
public class Quiz5 extends AppCompatActivity {
    ...
    StorageReference storageRef = storage.getReferenceFromUrl("gs://quizapp-registration.appspot.com").child("q5.jpg");
    ImageView picture;
    RadioGroup rg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fStore.collection("questions").document("Q5");
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                question.setText(value.getString("question5"));
        ...
        final File file;
        try {
            file = File.createTempFile("picture5","JPG");
        } catch (IOException e) {
        ...
        storageRef.getFile(file).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Quiz5.this, "Image failed to load from Storage", Toast.LENGTH_SHORT).show();
            }
        });
